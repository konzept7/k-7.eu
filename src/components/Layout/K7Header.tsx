  ...
  return (
    <Header height={56} className={classes.header}>
      <Container className={classes.inner}>
          ...
          <Menu.Dropdown>
            ...
            {departments.map((department) => (
              <Menu.Item
                key={department.id}
                component={Link}
                to={`/services/${department.attributes.route}`}
              >
        ...
        <Group className={classes.links} spacing={5}>
          ...
          <Menu>
            <Menu.Target>
              <Text
                className={cx(classes.link, {
                  [classes.linkActive]: active === "services",
                })}
              >
                {t("services.services")}
              </Text>
        ...
        <Link to="/">
          <Image
            src={mediumDisplay ? LogoWithoutText : Logo}
            height={34}
            width={mediumDisplay ? 28 : 178}
          />
        </Link>
        ...
        <Group spacing={0} className={classes.social} position="right" noWrap>
          ...
          <ActionIcon
            size="lg"
            component="a"
            href="https://github.com/konzept7/"
          >
          ...
          <ActionIcon
            size="lg"
            component="a"
            href="https://www.linkedin.com/company/k-7/"
          >
